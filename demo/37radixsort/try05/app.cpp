...
void init(Renderer &gfx, Context &ctx)
{
	...
	scan_block(gfx, ctx, 2, buf_key.getHandle(), buf_scan.getHandle(), buf_sums.getHandle(), buf_flag.getHandle());
	scan_sums(gfx, ctx, buf_scan.getHandle(), buf_sums.getHandle());
	apply_sums(gfx, ctx, 2, buf_key.getHandle(), buf_scan.getHandle(), buf_sums.getHandle());
