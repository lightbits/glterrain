...
const char *vertex_shader_src = GLSL(
	...
	void main() {
		...
		out_velocity = mix(out_velocity, vec2(dx, dy), attraction);
...
void update(Renderer &gfx, Context &ctx, double dt)
{
	...
	tbo.bind();
	glBindBufferBase(GL_TRANSFORM_FEEDBACK_BUFFER, 0, tbo.getHandle());
	...
	gfx.setUniform("attraction", attraction);
	...
	// Upload back to vbo? Is this how to do this?
	vbo.bind();
